    ...
    <header className="bg-white text-black text-center px-6 py-3 flex justify-between">
      ...
      <div className="flex items-center gap-6">
        ...
        </div>
        {
          ...
          {isMenuOpen && (
        <div className="z-50 left-0 md:left-[calc(100%-300px)] absolute top-16  mt-2 max-w-[18rem] w-10/12 rounded-md shadow-lg bg-white ring-1 ring-black ring-opacity-5">
          <LeftSideBar/>
        </div>
      )}
      </div>
